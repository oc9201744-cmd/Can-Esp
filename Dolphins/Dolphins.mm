...
void *readStaticData(void *) {
    while (true) {
        ...
        if(moduleControl.systemStatus != TransmissionNormal){
            ...
            //角色控制器
            staticData.playerController = memoryTools.readPtr(memoryTools.readPtr(memoryTools.readPtr(memoryTools.readPtr(staticData.gwlordAddr + PubgOffset::PlayerControllerOffset[0]) + PubgOffset::PlayerControllerOffset[1]) + PubgOffset::PlayerControllerOffset[2]) + PubgOffset::PlayerControllerOffset[3]);
            //掩体判断
