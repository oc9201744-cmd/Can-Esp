//
// PUBG Mobile Offset Header - COMPLETE FIXED VERSION
...
namespace PubgOffset {
    ...
    namespace PlayerControllerParam {
        ...
        static constexpr long MouseOffset = 0x4C0;  // ADDED - for view angle
        ...
        namespace CameraManagerParam {
            static constexpr long PovOffset = 0x10F0;  // ADDED - MinimalViewInfo
        }
    }
    ...
    namespace ObjectParam {
        ...
        static constexpr long TeamOffset = 0x998;  // Fallback
        static constexpr long NameOffset = 0x960;
        static constexpr long HpOffset = 0x8B8;  // Fallback
        static constexpr long DeadOffset = 0x8B0;
        static constexpr long StatusOffset = 0x1058;
        static constexpr long ClassNameOffset = 0xC;
        
        // Weapon
        static constexpr long WeaponOneOffset = 0x920;  // ADDED - primary weapon
        
        // Gameplay states
        static constexpr long OpenTheSightOffset = 0x8C0;  // ADDED - aiming
        static constexpr long OpenFireOffset = 0x8C4;      // ADDED - firing
        
        // Materials
        static constexpr long GoodsListOffset = 0x5A0;  // ADDED - loot list
        
        namespace GoodsListParam {
            static constexpr long DataBase = 0x30;  // ADDED - item stride
        }
        ...
        namespace CoordParam {
            static constexpr long CoordOffset = 0x220;     // ADDED - position
            static constexpr long HeightOffset = 0x22C;    // ADDED - Z height
        }
        ...
        namespace MeshParam {
            ...
            static constexpr long HumanOffset = 0x230;     // ADDED - transform
            static constexpr long BonesOffset = 0x7F8;     // ADDED - bone array
        }
        ...
        namespace WeaponParam {
            ...
            static constexpr long ShootModeOffset = 0x7E0;  // ADDED - fire mode
        }
